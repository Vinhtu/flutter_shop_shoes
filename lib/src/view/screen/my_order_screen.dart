...
import 'package:flutter_shop_shoes/src/data/model/order.dart';
import 'package:flutter_shop_shoes/src/router/router_path.dart';
import 'package:flutter_shop_shoes/src/view/screen/component/myorder/order_product.dart';
...
class MyOrderScreen extends StatelessWidget {
  ...
  // const MyOrderScreen({Key? key, this.order}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              //     itemCount: cartViewModel.itemCount.length,
              //     itemBuilder: (_, index) {
